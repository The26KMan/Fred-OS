...
class InvariantChecker:
    REQUIRED = (
        ...
        "task_planning.cues",
        "task_competency.uncertainty_review_threshold",
        "task_competency.objective_terms",
        "task_competency.route_competencies",
        "task_competency.competency_providers",
    )
    ...
    def check(cls, config: RuntimeConfig) -> None:
        ...
        governance_system = str(config.get("governance.kernel_system_id"))
        ...
        maturities = config.get("systems.maturity")
    ...
    def _check_routes(config: RuntimeConfig, enabled: tuple[str, ...]) -> None:
        ...
        required_policy_keys = ("block", "review", "default")
        for policy_key in required_policy_keys:
            route_key = str(policy[policy_key])
    ...
    def _check_task_competency(config: RuntimeConfig) -> None:
        threshold = float(config.get("task_competency.uncertainty_review_threshold"))
